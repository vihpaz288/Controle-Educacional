...
<head>
  ...
  <title>Atividades respondidas</title>
    ...
    <div class="card mx-1 mx-md-9 shadow-2-strong" style="
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-lg-9">
            ...
            <div class="row">
            @foreach ($ativis as $ativi)
            <div class="col-sm-3 mb-3 mb-sm-0 card mx-auto">
              <div class="card-body">
                <h5 class="card-title">{!!$ativi->discipline->name!!}</h5>
                <h6 class="card-subtitle mb-2 text-body-secondary"> {{$ativi->name}}</h6>
                <p class="card-text">{!!$ativi->description!!}</p>
                <a class="btn btn-primary btn-block mb-2" href="{{ asset('storage/' . $ativi->filepath) }}" target="_blank">Arquivo</a>
              </div>
            </div>
            @endforeach
            </div>
